...
import com.shu.runbang.adapter.AddFriendRecyclerAdapter;
import com.shu.runbang.listener.OnRecyclerViewClickListener;
...
public class FriendActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initComponent() {
        ...
        adapter = new AddFriendRecyclerAdapter(user, new OnRecyclerViewClickListener() {
            @Override
