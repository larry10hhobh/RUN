...
import com.larry.shugo.adapter.GuiderViewPagerAdapter;
...
public class SplashActivity extends BaseActivity {
    ...
    private LinearLayout noFirstLayout;
    ...
    private void initIndicator(){
        ...
        currentIndex = 0;
        ((ImageView)indicatorLayout.getChildAt(0)).setImageResource(R.drawable.indicator_selector);

    }
    private void initViews(){
        views =new ArrayList<>();
        views.add(R.drawable.default_avatar);
        views.add(R.drawable.default_avatar_blue);
        views.add(R.drawable.default_avatar);
        views.add(R.drawable.default_avatar_blue);
        views.add(R.drawable.default_avatar);
        views.add(R.drawable.default_avatar_blue);
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                ((ImageView)indicatorLayout.getChildAt(currentIndex)).setImageResource(R.drawable.indicator_unselect);
                ((ImageView)indicatorLayout.getChildAt(position)).setImageResource(R.drawable.indicator_selector);
    ...
    private void initComponent(){
        ...
        noFirstLayout = (LinearLayout) findViewById(R.id.linear_splash_nofirst);
